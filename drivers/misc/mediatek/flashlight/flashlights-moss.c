...
/*JinTong.You@Cam.Drv add flash bring up for Moss 20210910*/
int torch_enable = 0;
...
static int moss_operate(int channel, int enable)
{
	...
	if (channel == MOSS_CHANNEL_CH1) {
        ...
        /*youjintong@cam.drv, 20211028, add flash status notify for charger*/
...
static int moss_probe(struct platform_device *pdev)
{
	...
	if (pdata->channel_num) {
        ...
        /*JinTong.You@Cam.Drv add flash bring up for Moss 20210903*/

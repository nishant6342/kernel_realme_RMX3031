...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC02M1_SENSOR_ID_APOLLOT,        //record sensor id defined in Kd_imgsensor.h
...
kal_uint16 addr_data_pair_init_apolot_gc02m1[] = {
    /*system*/
    0xfc,0x01,
    0xf4,0x41,
    0xf5,0xc0,
...
kal_uint16 addr_data_pair_preview_apolot_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_apolot_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_apolot_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_apolot_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_apolot_gc02m1[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(addr_data_pair_init_apolot_gc02m1,
        sizeof(addr_data_pair_init_apolot_gc02m1) / sizeof(kal_uint16));
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            if ((*sensor_id == GC02M1B_SENSOR_ID) && (read_cmos_eeprom_16(0x06) == 0x7D)) {

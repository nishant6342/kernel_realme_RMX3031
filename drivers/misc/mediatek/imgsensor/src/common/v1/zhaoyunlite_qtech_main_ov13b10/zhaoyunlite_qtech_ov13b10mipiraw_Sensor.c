...
#define PFX "zhaoyunlite_qtech_ov13b10_camera_sensor"
...
#include "zhaoyunlite_qtech_ov13b10mipiraw_Sensor.h"
...
#define ZHAOYUNLITE_QTECH_OV13B10_OTP
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = ZHAOYUNLITE_QTECH_MAIN_OV13B10_SENSOR_ID,
...
static kal_uint16 zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_zhaoyunlite_qtech_ov13b10[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x43,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_zhaoyunlite_qtech_ov13b10,
		sizeof(addr_data_pair_init_zhaoyunlite_qtech_ov13b10) / sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_zhaoyunlite_qtech_ov13b10[] = {
	//0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x23,
	0x0327, 0x04,
...
#if MULTI_WRITE
	zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_zhaoyunlite_qtech_ov13b10,
		sizeof(addr_data_pair_preview_zhaoyunlite_qtech_ov13b10) / sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_zhaoyunlite_qtech_ov13b10[] = {
//  0x0100, 0x00,
    0x0303, 0x01,
    0x0305, 0x43,
    0x0327, 0x05,
...
kal_uint16 addr_data_pair_capture_30fps_zhaoyunlite_qtech_ov13b10[] = {
//	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x44,
	0x0327, 0x05,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_zhaoyunlite_qtech_ov13b10,
		sizeof(addr_data_pair_capture_15fps_zhaoyunlite_qtech_ov13b10) /
		sizeof(kal_uint16));
	} else {
	zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_zhaoyunlite_qtech_ov13b10,
		sizeof(addr_data_pair_capture_30fps_zhaoyunlite_qtech_ov13b10) /
		sizeof(kal_uint16));
	}
#else
if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_zhaoyunlite_qtech_ov13b10[] = {
//	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x44,
	0x0327, 0x05,
...
#if MULTI_WRITE
	zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_zhaoyunlite_qtech_ov13b10,
		sizeof(addr_data_pair_video_zhaoyunlite_qtech_ov13b10) /
		sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x46);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_zhaoyunlite_qtech_ov13b10[] = {
    //0x0100, 0x00,
    0x0303, 0x01,
    0x0305, 0x23,
    0x0327, 0x04,
...
#if MULTI_WRITE
	zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_zhaoyunlite_qtech_ov13b10,
		sizeof(addr_data_pair_hs_video_zhaoyunlite_qtech_ov13b10) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_zhaoyunlite_qtech_ov13b10[] = {
    //0x0100, 0x00,
    0x0303, 0x01,
    0x0305, 0x23,
    0x0327, 0x04,
...
#if MULTI_WRITE
	zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_zhaoyunlite_qtech_ov13b10,
		sizeof(addr_data_pair_slim_video_zhaoyunlite_qtech_ov13b10) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custome1_30fps_zhaoyunlite_qtech_ov13b10[] = {
	0x0303, 0x01,
	0x0305, 0x43,
	0x0327, 0x05,
	0x3501, 0x0c,
...
#if MULTI_WRITE
	zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome1_30fps_zhaoyunlite_qtech_ov13b10,
		sizeof(addr_data_pair_custome1_30fps_zhaoyunlite_qtech_ov13b10) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custome2_24fps_zhaoyunlite_qtech_ov13b10[] = {
	0x0303, 0x01,
	0x0305, 0x43,
	0x0327, 0x05,
	0x3501, 0x0c,
...
#if MULTI_WRITE
	zhaoyunlite_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome2_24fps_zhaoyunlite_qtech_ov13b10,
		sizeof(addr_data_pair_custome2_24fps_zhaoyunlite_qtech_ov13b10) /
		sizeof(kal_uint16));
#endif
}
...
#ifdef ZHAOYUNLITE_QTECH_OV13B10_OTP
...
static int read_zhaoyunlite_qtech_ov13b10_module_id(void)
{
	kal_uint16 zhaoyunlite_qtech_ov13b10_moduleid_id=0x0;
	zhaoyunlite_qtech_ov13b10_moduleid_id = read_cmos_sensor_qtech_otp(0x0000);
	return zhaoyunlite_qtech_ov13b10_moduleid_id;
}
#endif

static void read_zhaoyunlite_qtech_ov13b10_QRSerialdata(UINT8 *zhaoyunlite_qtech_ov13b10_QRSerialdata,
	UINT32 *feature_para_len)
{
	...
	for(i = 0; i < 17; i++){
		zhaoyunlite_qtech_ov13b10_QRSerialdata[i] = (kal_int8)read_cmos_sensor_qtech_otp(start_addr + i);
		LOG_INF("read_cmos_sensor_qtech_otp(start_addr + i) = 0x%x\n", read_cmos_sensor_qtech_otp(start_addr + i));
		checksum = checksum + zhaoyunlite_qtech_ov13b10_QRSerialdata[i];
	}
	checksum = checksum % 255;
	if(read_cmos_sensor_qtech_otp(start_addr+17) == 1 && read_cmos_sensor_qtech_otp(start_addr+18) == checksum ) {
		*feature_para_len = i;
		LOG_INF("zhaoyunlite_qtech_ov13b10_sn checksum sucess, feature_para_len；%d", *feature_para_len);
	} else {
		*feature_para_len = 0;
		LOG_INF("zhaoyunlite_qtech_ov13b10_sn checksum failed");
	}
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			if (is_project(21107) || is_project(21361) || is_project(21362)
			|| is_project(21363)){
...
#ifdef ZHAOYUNLITE_QTECH_OV13B10_OTP
				if(read_zhaoyunlite_qtech_ov13b10_module_id() == 0x05)
				{
					*sensor_id = imgsensor_info.sensor_id;
//					hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "Qtech");
					Eeprom_DataInit(0, ZHAOYUNLITE_QTECH_MAIN_OV13B10_SENSOR_ID);
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_SERIANO_IC:
		read_zhaoyunlite_qtech_ov13b10_QRSerialdata(feature_data_8, feature_para_len);

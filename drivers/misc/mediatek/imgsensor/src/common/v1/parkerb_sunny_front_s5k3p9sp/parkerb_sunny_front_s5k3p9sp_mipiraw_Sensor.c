...
static struct imgsensor_info_struct imgsensor_info = {
		.sensor_id = PARKERB_SUNNY_FRONT_S5K3P9SP_SENSOR_ID_ORIGINAL,
		#ifdef OPLUS_FEATURE_CAMERA_COMMON
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				*sensor_id = PARKERB_SUNNY_FRONT_S5K3P9SP_SENSOR_ID;
				...
				if(deviceInfo_register_value == 0x00){
					...
					Eeprom_DataInit(1, PARKERB_SUNNY_FRONT_S5K3P9SP_SENSOR_ID);
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	*/
	...
	/*  20190601, add for sensor different size sensitivity ratio*/

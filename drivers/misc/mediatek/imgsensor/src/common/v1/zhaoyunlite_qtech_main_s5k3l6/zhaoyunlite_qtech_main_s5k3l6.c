 ...
 * Filename:
 * ---------
 *   zhaoyunlite_qtech_main_s5k3l6.c
 *
 * Project:
 * --------
 *   ALPS
...
#define PFX "zhaoyunlite_qtech_main_s5k3l6_camera_sensor"
...
#include "zhaoyunlite_qtech_main_s5k3l6.h"
...
static struct imgsensor_info_struct imgsensor_info = {
  .sensor_id = ZHAOYUNLITE_QTECH_MAIN_S5K3L6_SENSOR_ID,

...
#include "limu_shinetech_main_imx355.h"
#include "imgsensor_common.h"

#define PFX "LIMU_IMX355_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = LIMU_SHINETECH_MAIN_IMX355_SENSOR_ID,
			...
			*sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
			...
			if (*sensor_id == 0x355) {
				*sensor_id = imgsensor_info.sensor_id;
				#ifdef OPLUS_FEATURE_CAMERA_COMMON
				Eeprom_DataInit(0, LIMU_SHINETECH_MAIN_IMX355_SENSOR_ID);
				#endif

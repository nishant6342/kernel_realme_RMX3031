...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PARKERA_HOLITECH_FRONT_S5K4H7_SENSOR_ID_ORIGINAL,	/*PARKERA_HOLITECH_FRONT_S5K4H7_SENSOR_ID = 0x487E */
	...
	do {
		*sensor_id = return_sensor_id();
		...
		if (*sensor_id == imgsensor_info.sensor_id) {
		    Eeprom_DataInit(1, PARKERA_HOLITECH_FRONT_S5K4H7_SENSOR_ID);
			LOG_INF(

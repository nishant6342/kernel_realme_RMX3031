...
/*Yanjie for HQ
 * gt9778AF_s5kjn103 voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "gt9778AF_s5kjn103_DRV"
...
static u8 read_data(u8 addr)
{
    ...
    LOG_INF("[gt9778AF_s5kjn103] get_byte %d\n", get_byte);
    return get_byte;
}
...
static int s4AF_ReadReg(unsigned short *a_pu2Result)
{
    ...
    *a_pu2Result = (read_data(0x03) << 8) + (read_data(0x04) & 0xff);
    LOG_INF("[gt9778AF_s5kjn103]  s4gt9778AF_s5kjn103_ReadReg %d\n", *a_pu2Result);
    return 0;
}
...
/* ////////////////////////////////////////////////////////////// */
long GT9778AF_S5KJN103_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
    long i4RetValue = 0;
...
int GT9778AF_S5KJN103_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
...
int GT9778AF_S5KJN103_PowerDown(struct i2c_client *pstAF_I2Cclient,
            int *pAF_Opened)
{
...
int GT9778AF_S5KJN103_GetFileName(unsigned char *pFileName)
{
...
int GT9778AF_S5KJN103_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
    int ret = 0;

...
/* ////////////////////////////////////////////////////////////// */
long DW9718TAF_PARKERA_S5KJN103_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9718TAF_PARKERA_S5KJN103_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    int i4RetValue = 0;
...
int DW9718TAF_PARKERA_S5KJN103_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9718TAF_PARKERA_S5KJN103_GetFileName(unsigned char *pFileName)
{

...
/*
 * FP5513AF_LIMU voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "FP5513AF_DRV_LIMU"
...
/* ////////////////////////////////////////////////////////////// */
long FP5513AF_LIMU_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int FP5513AF_LIMU_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
...
int FP5513AF_LIMU_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int FP5513AF_LIMU_GetFileName(unsigned char *pFileName)
{

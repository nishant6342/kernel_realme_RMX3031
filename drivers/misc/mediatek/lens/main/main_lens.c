...
{
    int Status = -1;
    if (fail_update_cnt < 3 && (is_project(20171) || is_project(20353) || is_project(20181) || is_project(20355) || is_project(20615) || is_project(20662) || is_project(20619) || is_project(21609) || is_project(21651))
        ...
        if (AK7375CAF_checkPIDparam() && !success_check_cnt) {
            ...
            if (is_project(20615) || is_project(20662) || is_project(20619) || is_project(21609) || is_project(21651)){
                Status = fan53870_cam_ldo_disable(6);
                if (Status < 0) {
                    LOG_INF("Camera Power disable error\n");
                } else {
                    LOG_INF("Camera Power disable %d\n", Status);
                }
                msleep(2);

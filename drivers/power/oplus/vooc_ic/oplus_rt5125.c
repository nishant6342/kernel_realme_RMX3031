...
extern int oplus_chg_get_chg_type(void);
int rt5125_get_prev_battery_mvolts(void)
{
	...
	if (!oplus_chg_get_chg_type()) {
		chg_debug("chg_type none cannot read volts\n");
		return 0;
	}
	...
	if (oplus_vooc_get_fastchg_started() != true) { /*for engineermode volt-diff test*/
...
static int rt5125_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_RT5125_4450_VOOC_FFC_10V5A_7BIT_20615) {
		chip->firmware_data = rt5125_fw_data_4450_vooc_ffc_10v5a_7bit_20615;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_vooc_ffc_10v5a_7bit_20615);
		chip->fw_data_version = rt5125_fw_data_4450_vooc_ffc_10v5a_7bit_20615[chip->fw_data_count - 4];
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_RT5125_4450_VOOC_FFC_5V6A_7BIT_20619) {
		chip->firmware_data = rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_20619;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_20619);
		chip->fw_data_version = rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_20619[chip->fw_data_count - 4];
	...
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_RT5125_4450_VOOC_FFC_10V6A_7BIT_MT6893) {
		chip->firmware_data = rt5125_fw_data_4450_vooc_ffc_10v6a_7bit_mt6893;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_vooc_ffc_10v6a_7bit_mt6893);
		chip->fw_data_version = rt5125_fw_data_4450_vooc_ffc_10v6a_7bit_mt6893[chip->fw_data_count - 4];
	}

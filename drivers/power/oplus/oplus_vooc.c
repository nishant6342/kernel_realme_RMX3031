...
*/
	...
	ret_info = 0x2;
		...
		vooc_xlog_printk(CHG_LOG_CRTI, "allow_reading volt:%d,temp:%d,soc:%d,current_now:%d,rm:%d, i2c_err:%d\n",
		...
		vooc_xlog_printk(CHG_LOG_CRTI, " temp_range volt:%d,temp:%d,soc:%d,current_now:%d,rm:%d, i2c_err:%d, ret_info:%d\n",

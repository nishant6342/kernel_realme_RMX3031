...
static void lcm_panel_init(struct lcm *ctx)
{
	pr_info("SYQ %s+\n", __func__);
        ...
        lcm_dcs_write_seq_static(ctx, 0xCE, 0x0F, 0x40, 0x60, 0x78, 0x87, 0x94, \
				0x9e, 0xab, 0xb8, 0xc4, 0xcd, 0xd6, 0xde, 0xe5, 0xec, 0xf3, 0xff, 0x07, 0x0F, 0x0a, 0x18, 0x36, 0x04, 0x8C); //LEDPWM=30KHz and 12bit DBV

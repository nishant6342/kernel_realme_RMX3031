...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx,0xC3,0x9A,0x01,0x9D,0xD0,0x20,0x81,0x00);
    ...
    /* Normal Display */
    lcm_dcs_write_seq_static(ctx,0x2F,0x02);//01 60 02 90
...
static struct LCM_setting_table lcm_normal_to_aod_sam[] = {
    ...
    {REGFLAG_CMD, 8, {0xC3,0x9A,0x01,0x9D,0xD0,0x20,0x81,0x00}},

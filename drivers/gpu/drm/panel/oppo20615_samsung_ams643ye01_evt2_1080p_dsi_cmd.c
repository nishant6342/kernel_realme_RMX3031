...
#include "../mediatek/mtk_corner_pattern/oppo20615_mtk_data_hw_roundedpattern.h"
#include "../mediatek/mtk_corner_pattern/oppo20615_mtk_data_hw_roundedpattern_l.h"
#include "../mediatek/mtk_corner_pattern/oppo20615_mtk_data_hw_roundedpattern_r.h"
#endif
...
#define OPPO_DC_BACKLIGHT_THRESHOLD 650
...
static int oppo_lcm_dc_post_exitd(void *dsi, dcs_write_gce cb,void *handle)
{
	...
	pr_err("debug for lcm, oppo_dc_enable = %d\n", oplus_dc_enable);
	for (i = 0; i < sizeof(lcm_seed_setting)/sizeof(lcm_seed_setting[0]); i++){
		cb(dsi, handle, lcm_seed_setting[i].para_list, lcm_seed_setting[i].count);
	}
	return 0;
		...
		void *handle, unsigned int level)
{
	...
	if (mapped_level >1 && mapped_level < 4)
                mapped_level = 4;
		...
		void *handle, unsigned int hbm_mode)
{
	...
	esd_brightness = oppo_display_brightness_exp;
	...
	if(hbm_mode == 1) {
		oplus_lcm_dc_backlight(dsi,cb,handle, oppo_display_brightness_exp, 1);
		...
		//level = oplus_lcm_dc_backlight(dsi,cb,handle, oppo_display_brightness_exp, 0);
		lcm_setbrightness(dsi, cb, handle, oppo_display_brightness_exp);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oppo20615_samsung_ams643ye01_evt2_1080p_dsi_cmd", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oppo20615_samsung_ams643ye01_evt2_1080p_dsi_cmd",
		.owner = THIS_MODULE,

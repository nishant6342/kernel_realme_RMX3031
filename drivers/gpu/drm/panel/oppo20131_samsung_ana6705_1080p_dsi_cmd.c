...
static struct LCM_setting_table lcm_seed_setting[] = {
	...
	{REGFLAG_CMD,22,{0xB1,0xC6,0x05,0x00,0x09,0xD1,0x00,0x0C,0x00,0xC4,0x17,0xEF,0xD3,0xEB,0x05,0xD2,0xE2,0xEA,0x00,0xFF,0xFF,0xFF}},

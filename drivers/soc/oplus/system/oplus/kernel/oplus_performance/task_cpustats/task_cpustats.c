...
{
	sysctl_task_cpustats_enable = 0;
	proc_create("sgeinfo", S_IRUGO | S_IWUGO, NULL, &sge_proc_fops);
	proc_create("sgefreqinfo", S_IRUGO | S_IWUGO, NULL, &sgefreq_proc_fops);
	proc_create("task_cpustats", S_IRUGO | S_IWUGO, NULL, &task_cpustats_proc_fops);
	return 0;
}

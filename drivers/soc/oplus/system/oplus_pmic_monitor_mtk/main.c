...
#define STRUP_CON4_MAX 2
static char *const STRUP_CON4_reason_str[] = {
	[0] = ":RG_STRUPO_LONG_PRESS_EXT_SEL Selects Re-Power-On Scenario   2'b00:Debounce Pwrkey \
	2'b01:After releasing pwrkey  2'b10:After releasing pwrkey and pressing pwrkey again",
	[1] = ":RG_STRUPO_LONG_PRESS_EXT_SEL Selects Re-Power-On Scenario   2'b00:Debounce Pwrkey \
	2'b01:After releasing pwrkey  2'b10:After releasing pwrkey and pressing pwrkey again",
				...
				struct kobj_attribute *attr, char *buf)
{
	...
	for (pmic_device_index = 0; pmic_device_index < pmic_history_count;
		...
		if (DATA_VALID_FLAG !=
				pmic_first_record.pmic_pon_poff_reason[0].data_is_valid) {
			continue;
		}
